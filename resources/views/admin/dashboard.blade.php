                                ...
                                <div class="card-block">
                                    <div class="media">
                                        <div class="media-body text-xs-left">
                                            <h3 class="pink">{{ $produitCount }}</h3>
                                            <span>Produit</span>
                                        </div>
                                        <div class="media-right media-middle">
                                            <i class="icon-shopping-cart pink font-large-2 float-xs-right"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-block">
                                    <div class="media">
                                        <div class="media-body text-xs-left">
                                            <h3 class="deep-orange">{{ $count }}</h3>
                                            <span>Rupture Produit</span>
                                        </div>
                                        <div class="media-right media-middle">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-block">
                                    <div class="media">
                                        <div class="media-body text-xs-left">
                                            <h3 class="cyan">{{ $commandeCount }}</h3>
                                            <span>Commande</span>
                                        </div>
                                        <div class="media-right media-middle">
