        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-xs-12 mb-1">
                    <h2 class="content-header-title">Stock</h2>
                </div>
                            ...
                            <div class="card-body collapse in">
                                <div class="card-block card-dashboard">
                                    <div class="table-responsive">
                                        <form method="POST" action="{{ route('entreestock.update',$stock->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="produit">
                                                            ...
                                                            <option {{ $produit->id == $stock->produit->id ? 'selected' : '' }} value="{{ $produit->id }}">{{ $produit->nomP }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="fournisseur">
                                                            ...
                                                            <option {{ $fournisseur->id == $stock->fournisseur->id ? 'selected' : '' }} value="{{ $fournisseur->id }}">{{ $fournisseur->nomF }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" id="projectinput3" class="form-control" placeholder="Date" name="date">
